...
//     // Debug print
//     printf("Node %lu → Community %lu: ki_to_C = %.3f, ki = %.3f, kC = %.3f, deltaQ = %.6f\n",
//         ix, jx, ki_to_C, ki, kC, z->score);
//     printf("z: k = %ld, score: %f, tiebreaker = %f\n", z->k, z->score, z->tb);
// }
...
//         // GrB_Index comms = 0;
//         // GrB_Matrix_ncols(&comms, A);
//         // printf("Num communities: %lu\n", comms);
//         iter++;
//     }
//     dbg(A);
//     // GxB_print(S,3);
...
//     double Q;
//     double gamma = 1;
//     GRB_TRY(LAGr_Modularity2(&Q, gamma, G->A, S, msg));
//     printf("Q:%f\n", Q);
//     (*S_result) = S;
//     S = NULL;
//     LG_FREE_ALL;
